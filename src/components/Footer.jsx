...
export function Footer(){
    return(
        <footer className="border-t border-border/40 py-6 dark:border-border md:px-3 md:py-0 w-screen fixed bottom-0">
            <div className="grid grid-cols-4 gap-10 my-6 pb-10"> 
                <div className="...">
                    <div className="flex flex-col">
                        <img className="ml-10" src={mealshare_logo} alt="logo" width="100px"/>     
                        <img className="ml-9" src={social_media_icons} alt="social_media_icons" width="100px"/>     
                    </div>
                </div>
                <div className="...">  
                    <div className="flex flex-col ...">
